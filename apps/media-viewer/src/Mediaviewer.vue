<template>
  <div id="mediaviewer" class="uk-position-relative">
    ...
    <oc-spinner v-if="loading" class="uk-position-center" size="large" />
    <oc-icon
      v-if="failed"
      name="review"
      variation="danger"
    ...
    <div class="uk-position-medium uk-position-bottom-center">
      ...
      <div class="uk-overlay uk-overlay-primary uk-light uk-padding-small">
        ...
        >
          ...
          <span class="uk-text-small" style="color:#fff">
...
export default {
  ...
  computed: {
    ...
    thumbPath() {
      ...
      if (this.publicPage()) {
        const path = ['..', 'dav', 'public-files', this.activeMediaFile.path].join('/')
