...
const setTrustedServer = function(url) {
  ...
  const postUrl = join(
    ...
    '/ocs/v2.php/apps/testing/api/v1/trustedservers?format=json'
  )
  return fetch(postUrl, { method: 'POST', headers, body }).then(res => {
...
After(async function(testCase) {
  ...
  await fetch(
    join(client.globals.backend_url, '/ocs/v2.php/apps/testing/api/v1/lockprovisioning'),
